# ====================================================================================
# Setup Project
PROJECT_NAME := provider-cassandra
...
xpkg.build.provider-cassandra: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Cassandra CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Cassandra controllers
...
# This target prepares repo for your provider by replacing all "cassandra"
